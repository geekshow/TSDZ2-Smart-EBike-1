...
This fork is based on the v0.20beta1 adapted for Tong Sheng protocol displays, like stock LCD5, VLCD6, XH18 or Enerdan's SW102.
...
Note: firmware can't be written to Enerdan sold TSDZ2 motors and controllers because those have write protection.
